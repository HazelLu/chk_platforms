...
var app = {
    ...
    _postalList: function(v){
        var domStr='';
            ...
            domStr+= v.n != '0' && v.n!=undefined && v.n <=15 ? '<img class="source" src="img/source/'+ v.n +'.png" alt="" />':'';          
            domStr+='</div>';
            domStr+='<div class="info">';
            if(v.f=='0' || v.f=='1'){
            ...
            domStr+=v.o != '0' && v.o!=undefined && v.n <=11 ?'<img class="trace" src="img/trace/'+ v.o +'.png" alt="" />':'';
            domStr+='</h4>';
